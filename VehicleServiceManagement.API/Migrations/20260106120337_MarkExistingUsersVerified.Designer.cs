...
namespace VehicleServiceManagement.API.Migrations
{
    ...
    [Migration("20260106120337_MarkExistingUsersVerified")]
    partial class MarkExistingUsersVerified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.EmailVerificationOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.InAppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.PartOrder", b =>
                {
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.ServiceRequestCategory", b =>
                {
                    b.Property<int>("ServiceRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ServiceRequestId", "CategoryId");
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.ServiceTask", b =>
                {
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "User",
                            PasswordHash = "$2a$11$JuSvE/cg1XlyLodwPhgy2ejbNBSW3RpHHiw7SVm5f4rygGkl/1inW",
                        ...
                        new
                        {
                            ...
                            IsPendingApproval = false,
                            LastName = "Manager",
                            PasswordHash = "$2a$11$KBA8F9UmPMQas3mydxg4luBiFddcFU8E.SDE.mCTQk6y3KYRU6Bzu",
                        ...
                        new
                        {
                            ...
                            IsPendingApproval = false,
                            LastName = "Tech",
                            PasswordHash = "$2a$11$zZ2ZNCPkjlbTuw6s8cPHIOqMObBCOSrPsOz/leOUCSOWLZgM8pEHO",
                        ...
                        new
                        {
                            ...
                            IsPendingApproval = false,
                            LastName = "Mechanic",
                            PasswordHash = "$2a$11$kgN1BCEMJrNCXKKH1mXxZumg1hjtickih/uyrw4fYDvF/ox7A4IA2",
                        ...
                        new
                        {
                            ...
                            IsPendingApproval = false,
                            LastName = "Customer",
                            PasswordHash = "$2a$11$.U.BT9rm5XK74pc49FeVG.pzyRUeyBWFbIaAFp3k.R4BXxbwnPPdS",
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.EmailVerificationOtp", b =>
                {
                    b.HasOne("VehicleServiceManagement.API.Models.User", "User")
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.InAppNotification", b =>
                {
                    b.HasOne("VehicleServiceManagement.API.Models.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("VehicleServiceManagement.API.Models.User", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.PartOrder", b =>
                {
                    b.HasOne("VehicleServiceManagement.API.Models.User", "OrderedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.ServiceRequestCategory", b =>
                {
                    b.HasOne("VehicleServiceManagement.API.Models.ServiceCategory", "ServiceCategory")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("VehicleServiceManagement.API.Models.ServiceRequest", "ServiceRequest")
                        .WithMany("ServiceRequestCategories")
                        .HasForeignKey("ServiceRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.ServiceTask", b =>
                {
                    b.HasOne("VehicleServiceManagement.API.Models.User", "CompletedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleServiceManagement.API.Models.ServiceRequest", b =>
                {
                    ...
                    b.Navigation("ServiceRequestCategories");
